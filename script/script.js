...
const LanguageMap = {
    'pt-BR': {
        ...
        'I1-P1':'Somos uma STARTUP incubada no Polo Tecnológico e Criativo, conhecido também como Polo TeC, da Universidade Federal de Pernambuco (UFPE). A BIOTEC tem capacidade de desenvolver produtos e serviços inovadores voltado para as necessidades de cada cliente, como: valorização de resíduos, biomassas, hidrogênio verde, biogás e biofertilizantes.',
        'I1-P2':'Contamos com uma equipe experiente, qualificada, criativa, inovadora e disruptiva, buscando soluções eficientes e resultados consistentes para que nossos clientes possam enfrentar, com melhores recursos, as lutas diárias da competitividade com sustentabilidade.',
        'I2-P1':'Animação',
        'I2-H3':'Competências',
    ...
    'en': {
        ...
        'I1-P2':'We have an experienced, qualified, creative, innovative, and disruptive team, seeking efficient solutions and consistent results so that our clients can face the daily struggle of competitiveness with sustainability and better resources.',
        'I2-P1':'Animation',
        'I2-H3':'Competences',
